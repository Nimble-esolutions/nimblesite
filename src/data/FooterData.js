...
const footerData = {
  ...
  posts,
  postsSix,
  aboutTwoText: "Whether it is an application development or it is website development, the requirements analysis and scope definition are the most crucial steps. We bring our experience on the table to get these steps right at the beginning. We work closely with end user and the developement agency to create scope documentation and its UI.",
  widgetText:
