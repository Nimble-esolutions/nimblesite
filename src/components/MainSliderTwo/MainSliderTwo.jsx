                    ...
                    <Col xl={7}>
                        <div className="main-slider-two__content">
                            <h2 className="main-slider-two__title wow fadeInUp" data-aos='fade-up' data-aos-delay="100">
                                ...
                                <Typewriter
                                    className="typewrite"
                                    words={["AI Solutions", "Product Development", "Product Enhancement", "e-Learning Solutions", "Website Development"]}
                                    loop={0}
                                    cursor
                                    cursorStyle='|'
                                    typeSpeed={70}
                            ...
                            <div className="main-slider-two__btn wow fadeInUp" data-aos='fade-up' data-aos-delay="400ms">
                                <a href="about.html" className="tolak-btn"><b>Get In Touch</b><span></span></a>
                            </div>
                        </div>
                    </Col>
                    <Col xl={5} >
