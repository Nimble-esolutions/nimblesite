...
const HeaderTwo = () => {
    ...
    const { toggleSearch, handleToggle, toggleSidebar, toggleMegaMenu, openMegaMenu, setOpenMegaMenu } = useRootContext()
    return (
        <header className={`main-header-two sticky-header sticky-header--normal  ${scrollToTop ? "active" : ""}`}>
