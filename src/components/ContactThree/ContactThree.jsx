...
const options = ["Select Service", "AI Driven Applications", ".Net/Python Development", "Product Enhancement", "Website, e-commerce Portal development"].map(
    (it) => ({
        value: it,
        label: it,
    })
                                    ...
                                    <div className="form-one__group">
                                        ...
                                        <div className="form-one__control form-one__control--full">
                                            <button type="submit" className="tolak-btn-two tolak-btn-two--home-six">
                                                ...
                                                <span>Send Enquiry<i className="tolak-icons-two-arrow-right-short"></i></span>
